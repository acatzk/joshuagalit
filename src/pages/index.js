        ...
        <section className="flex flex-col md:flex-row-reverse items-center justify-center mx-auto w-full max-w-7xl px-4 py-4 md:py-12 md:px-12">
          ...
          <div className="flex flex-col space-y-6 pt-4">
            <div className="flex flex-col space-y-4 w-full max-w-md">
              ...
              <p className="tracking-wide leading-7">My name is <span className="font-semibold">Joshua Galit</span> and I'm a self taught web developer using modern technologies and a future frontend developer. Addicted in GitHub contribution and commits.</p>
            </div>
