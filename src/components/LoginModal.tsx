    ...
    <Transition show={isOpen} as="div" static className="fixed z-10 inset-0">
      <div className="flex items-center justify-center min-h-screen text-center sm:block sm:p-0">
        ...
        <motion.div variants={fadeInUp}>
          ...
          <div className="inline-block align-top rounded-lg overflow-hidden shadow-2xl transform transition-all sm:align-middle sm:max-w-lg sm:w-full">
            <div className="bg-white dark:bg-dark-dim px-4 py-6 transition ease-in-out duration-700">
              <div className="flex flex-col items-center space-y-3">
                ...
                >
                  {loginWith.map(({ title, Icon, color }, i) => (
                    <motion.button
                      key={i}
                      variants={fadeInUp}
